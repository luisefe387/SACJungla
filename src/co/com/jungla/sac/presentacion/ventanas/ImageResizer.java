...
/**
 * clase para definir los atributos y metodos tanto para la construccion de la ventana como para las funcionalidades para
 *  llevar a cabo los metodos necesarios para copiar, guardar y redimensionar una imagen
...
public class ImageResizer {
    ...
    /*Este método es el que recibe la ruta al archivo original y la ruta donde vamos a guardar la copia*/
