...
public class VentBuscarClienteRecaudosCaja extends JDialog {
	...
	VentMostrarRecaudosCaja ventMostrarRecaudosCaja = new VentMostrarRecaudosCaja();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentBuscarClienteRecaudosCaja frame = new VentBuscarClienteRecaudosCaja();
	 ...
	 * Create the frame.
	 */
	public VentBuscarClienteRecaudosCaja() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(VentBuscarClienteRecaudosCaja.class.getResource("/co/com/jungla/sac/presentacion/imagenes/Logo Jungla.png")));
		...
		btnContinuar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				cargarDatosAVentMostrarRecaudosCaja();
			}
		});
		...
		btnCancelar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				ventMostrarRecaudosCaja.setVisible(true);
			}
		});
	...
	//Metodo para validar los datos ingresados para su posterior busqueda
	...
	//Metodo para listar los clientes de acuerdo a los parametros de nombre o identificacion
	...
	//Metodo para cargar los datos encontrados del cliente y ponerlos en la ventana mostrar recuados caja
	private void cargarDatosAVentMostrarRecaudosCaja(){
		Cliente datosCliente= listaClientes.get(filaSeleccionada);
		ventMostrarRecaudosCaja.setVisible(true);
		ventMostrarRecaudosCaja.agregarDatosARecuadosCaja(datosCliente);
		dispose();
	}
	...
	private void crearCliente() {
		...
		ventRegistrarCliente.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
            	...
            	ventMostrarRecaudosCaja.agregarDatosARecuadosCaja(cliente.get(0));
            	ventMostrarRecaudosCaja.setVisible(true);  
            }
        });
